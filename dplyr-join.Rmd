...
```{r, eval=TRUE}
# county level data
demo <- read_csv("data/county_demographics.csv")
cases <- read_csv("data/county_cases.csv")
deaths <- read_csv("data/county_deaths.csv")

# state level data
state_stats <- read_csv("data/state_covid.csv")
```
...
Sometime, R will warn you that there there might be a problem.
